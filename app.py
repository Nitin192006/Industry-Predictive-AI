...
with st.sidebar:
    ...
    st.info("""
    Upload the AI4I formatted sensor CSV
    and an accompanying thermal image.
    """)
...
if analyze_btn and sensor_file and image_file:
    ...
    # =====================================================
    # CREATE SENSOR SEQUENCE
    # =====================================================

    sequence = df[sensor_cols] \
        .tail(10) \
        .values
    ...
    with st.spinner(
        'Neural networks aligning modalities...'
    ):
    ...
    with viz1:
        ...
        st.subheader(
            "High-Frequency Sensor Dynamics"
        )
